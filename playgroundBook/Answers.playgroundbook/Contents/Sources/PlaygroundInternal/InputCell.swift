...
class InputCell: MessageCell, UITextViewDelegate {
    ...
    static let submitTitleString: NSAttributedString = {
        ...
        return NSAttributedString(string: submitButtonTitle, attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: UIFont.labelFontSize, weight: UIFontWeightMedium)])
    }()
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        textEntryMinimumWidthConstraint.priority = UILayoutPriorityDefaultHigh
